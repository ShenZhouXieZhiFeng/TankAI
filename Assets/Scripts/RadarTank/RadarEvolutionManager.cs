...
/// 管理进过进化过程
/// </summary>
public class RadarEvolutionManager : SingletonMono<RadarEvolutionManager>
{
    #region 属性
  ...
  //在特定的等待时间之后重新启动算法
    ...
    private void StartEvaluation(IEnumerable<Genotype> currentPopulation)
    {
        ...
        RadarTankManager.instance.SetTankAmount(agents.Count);
        IEnumerator<RadarTank> carsEnum = RadarTankManager.instance.GetTankEnumerator();
        ...
        //重新启动
        RadarTankManager.instance.Restart();
    }
